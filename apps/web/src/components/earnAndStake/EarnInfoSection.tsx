...
const StakeInfoSection: FC = () => {
  ...
  const { data, isLoading } = useUserStakingInfo('earning');
    ...
    <Surface borderMd className={styles.root}>
      ...
      <Row className={styles.row} justify="space-between" align="top" gutter={[16, 16]}>
        ...
        <Col className={styles.right}>
          ...
          {/* <StakingPnl
            percent={data?.pnl?.percent || 0}
            assetYesterday={data?.pnl?.assetYesterday || 0}
            className={styles.pnlBox}
          /> */}
        </Col>
      </Row>
    </Surface>
