    ...
    class HistoryProvider {
        ...
        getBars(symbolInfo, resolution, periodParams) {
            ...
            return new Promise((resolve, reject) => {
                this._requester.sendRequest(this._datafeedUrl, 'bb/market/history', requestParams)
                    .then((response) => {
    ...
    class UDFCompatibleDatafeedBase {
        ...
        resolveSymbol(symbolName, onResolve, onError, extension) {
            ...
            if (!this._configuration.supports_group_request) {
                ...
                this._send('tradingview/symbols', params)
                    .then((response) => {
                    if (response.s !== undefined) {
                        onError('unknown_symbol');
                    }
                    else {
                        // Fixme: Wait till BE update.
                        const data = Object.assign(Object.assign({}, response), { type: "crypto", session: "24x7" });
                        onResultReady(data);
        ...
        _requestConfiguration() {
            return this._send('tradingview/config')
                .catch((reason) => {
